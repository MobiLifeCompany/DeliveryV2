...
.controller('ShopsCtrl', function ($scope, $rootScope,$ionicLoading, $ionicModal, $timeout, $ionicPlatform, $ionicFilterBar) {
    ...
    $scope.shops = [
        { title: 'Shop ONE', id: 1 , src: "img/categories/icon1.jpg"},
        { title: 'Shop TWO', id: 2, src: "img/categories/icon2.jpg" },
        { title: 'Shop THREE', id: 3, src: "img/categories/icon3.jpg" },
        { title: 'Shop FOUR', id: 4, src: "img/categories/icon4.jpg" },
        { title: 'Shop FIVE', id: 5, src: "img/categories/icon5.jpg" },
        { title: 'Shop SIX', id: 6, src: "img/categories/icon6.jpg" }
    ];
